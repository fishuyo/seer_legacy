...
importPackage(com.fishuyo.seer.examples.particleSystems.grass)
...
Trackpad.bind(function(i,f){
	...
	if( i == 1){
		...
		dx1 += f[2]*0.01
		dy1 += f[3]*0.01
		var grass = Main.blades().apply(0)
		grass.applyForce(Vec3(0.0001,0.0,0.0))

	}else if( i==3 ){
		dx2 += f[2]*0.01
		dy2 += f[3]*0.01
		var grass = Main.blades().apply(0)
		grass.applyForce(Vec3(-0.01,0.0,0.0))
