...
// package org.scaladom.raw

// import scala.scalajs
// import scala.scalaannotation._
// import scala.scalatypedarray._
...
// @native
// @JSGlobal
// class WebGLBuffer private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLFramebuffer private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLProgram private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLRenderbuffer private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLShader private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLTexture private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLUniformLocation private[this] () extends Object
...
// @native
// @JSGlobal
// class WebGLActiveInfo private[this] () extends Object {
...
// @native
// @JSGlobal
// class WebGLShaderPrecisionFormat private[this] () extends Object {
...
object GLContext {
  /* Note:
   *   Normally we'd make this object @native extends Object
   *   and declare all these vals as native, however Safari does
  ...
  def bindFramebuffer(target: Int,
      framebuffer: WebGLFramebuffer): Unit
  ...
  def bindRenderbuffer(target: Int,
      renderbuffer: WebGLRenderbuffer): Unit
  ...
  def bufferSubData(target: Int, offset: Int,
      data: ArrayBufferView): Unit

  def bufferSubData(target: Int, offset: Int,
      data: ArrayBuffer): Unit
  ...
  def copyTexImage2D(target: Int, level: Int, internalformat: Int, x: Int,
      y: Int, width: Int, height: Int, border: Int): Unit
  ...
  def framebufferTexture2D(target: Int, attachment: Int, textarget: Int,
      texture: WebGLTexture, level: Int): Unit
  ...
  def getAttachedShaders(
      program: WebGLProgram): Array[WebGLShader]
  ...
  def getUniform(program: WebGLProgram,
      location: WebGLUniformLocation): Any
  ...
  def readPixels(x: Int, y: Int, width: Int, height: Int, format: Int,
      `type`: Int, pixels: ArrayBufferView): Unit
  ...
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int,
      `type`: Int, pixels: ImageData): Unit
   ...
   */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int,
      `type`: Int, pixels: HTMLImageElement): Unit
   ...
   */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int,
      `type`: Int, pixels: HTMLCanvasElement): Unit
   ...
   */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int,
      `type`: Int, pixels: HTMLVideoElement): Unit
   ...
   */
  def texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int,
      format: Int, `type`: Int, pixels: ImageData): Unit
   ...
   */
  def texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int,
      format: Int, `type`: Int, pixels: HTMLImageElement): Unit
   ...
   */
  def texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int,
      format: Int, `type`: Int, pixels: HTMLCanvasElement): Unit
   ...
   */
  def texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int,
      format: Int, `type`: Int, pixels: HTMLVideoElement): Unit
   ...
   * @param location  the location to bind.
   * @param transpose  if `true`, the matrix will loaded into the uniform transposed.
   * @param value  the source `Array` containing the matrix data.
   */
  def uniformMatrix2fv(location: WebGLUniformLocation, transpose: Boolean,
  ...
  def vertexAttribPointer(indx: Int, size: Int, `type`: Int,
      normalized: Boolean, stride: Int, offset: Int): Unit
