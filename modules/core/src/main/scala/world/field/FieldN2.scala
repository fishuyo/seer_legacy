...
// class Field[@sp(Float, Double) T : ClassManifest](val dims:Seq[Int]) {
//   val ndims = dims.length
//   val size = dims.fold(1)(_*_)
//   val data = new Array[T](size) //Array.fill(size)(implicitly[spire.math.Numeric[T]].zero)
