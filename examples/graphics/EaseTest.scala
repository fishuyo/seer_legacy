...
object EaseTest extends SeerApp { 
  ...
  val models = for(i <- 0 until 8) yield Sphere().scale(0.1)
  val modelsIn = for(i <- 0 until 8) yield Sphere().scale(0.1)
  val modelsOut = for(i <- 0 until 8) yield Sphere().scale(0.1)
